function showPrivacy() {
    removeClass('loginprivacy', 'd-none');
    document.getElementById('loginprivacy').innerHTML = /*html*/`
    <div class="openloginareacreate">
        <div class="loginwindow">
            <img class="closelogin" src="img/close.png" onclick="closeShowPrivacy()">
            <div class="impsize">
                <div class='impressum'>
                    <h1>IMPRINT</h1><p>According to § 5 TMG</p><p>Yener Bas <br> 
...
function closeShowPrivacy() {
    addClass('loginprivacy', 'd-none');
    soundClose.play();
...
function showImprint() {
    removeClass('loginimprint', 'd-none');
    document.getElementById('loginimprint').innerHTML = /*html*/`
    <div class="openloginareacreate">
        <div class="loginwindow">
            <img class="closelogin" src="img/close.png" onclick="closeShowImprint()">
            <div class="impsize">
                <h2>SUPPORT</h2>
...
function closeShowImprint() {
    addClass('loginimprint', 'd-none');
    soundClose.play();
    soundClose.volume = 0.5;
    soundOpen.volume = 0;
}